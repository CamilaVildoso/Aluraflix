...
export const messages = {
  ...
  imagen: {
    ...
    patternMismatch:
      "La Url de la imagen tiene que empezar asi https://i.ytimg.com/vi/ y debe provenir de Youtube",
  },
  video: {
...
const GlobalContextProvider = ({ children }) => {
  ...
  useEffect(() => {
    fetch(
      "https://my-json-server.typicode.com/CamilaVildoso/json-Aluraflix/categorias"
    )
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(
      "https://my-json-server.typicode.com/CamilaVildoso/json-Aluraflix/videos"
    )
      .then((res) => res.json())
  ...
  const deleteVideo = (id) => {
    fetch(
      `https://my-json-server.typicode.com/CamilaVildoso/json-Aluraflix/videos/${id}`,
      { method: "DELETE" }
    )
      .then((res) => {
        if (!res.ok) {
